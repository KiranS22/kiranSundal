...
<head>
  ...
  <title>Kiran Sundal - portfolio</title>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Kiran Sundal</h1>
      <p>I'm <span class="typed" data-typed-items=" Hard-working, Dedicated, Self-motivated,  A Developer"></span></p>
    </div>
  </section><!-- End Hero -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>krnsundal@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Looking for:</strong> <span>Remote Work</span></li>
                </ul>
              </div>
            </div>
